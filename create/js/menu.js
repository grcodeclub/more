window.onload = function() {
    var menuLinks = [
        ...
        '<li><a href="https://grcodeclub.gr/more/create/dynamic-html">Δυναμική προσθήκη περιεχομένου Html</a></li>',
         '<li><a href="https://grcodeclub.gr/more/create/javascript-files">Αρχεία JavaScript</a></li>'
